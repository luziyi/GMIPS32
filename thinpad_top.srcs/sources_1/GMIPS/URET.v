/*
 * File:         e:\NSCSCC\GMIPS\thinpad_top.srcs\sources_1\GMIPS\URET
 * Project:      e:\NSCSCC\GMIPS\thinpad_top.srcs\sources_1\GMIPS
 * Created Date: 2024-07-17 16:04:17
 * Author:       Tommy Gong
 * description:  
 * ----------------------------------------------------
 * Last Modified: 2024-07-17 16:04:27
 */
...
module UART (
  ...
  assign Data_Out = (Addr == 32'hBFD003F8) ? ext_uart_buffer : (Addr == 32'hBFD003FC) ? {6'b0, ext_uart_ready, !ext_uart_busy} : 8'hAA;  //debug
